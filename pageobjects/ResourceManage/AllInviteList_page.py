...
class AllInvitePage(BasePage):
    ...
    #到访时间
    invite_time_0 = "xpath=>//label[contains(text(),'到访时间:')]/../a[@data-type='0']" #今天
    invite_time_1 = "xpath=>//label[contains(text(),'到访时间:')]/../a[@data-type='1']" #本周
    invite_time_2 = "xpath=>//label[contains(text(),'到访时间:')]/../a[@data-type='2']" #下月
    invite_time_3 = "xpath=>//label[contains(text(),'到访时间:')]/../a[@data-type='3']" #自定义查询时间
    invite_time_4 = "xpath=>//label[contains(text(),'到访时间:')]/../a[@data-type='4']" #报名成功
    ...
    #到访状态
    invite_status_0 = "xpath=>//label[contains(text(),'到访状态:')]/../a[@data-type='0']" #未到访
    invite_status_1 = "xpath=>//label[contains(text(),'到访状态:')]/../a[@data-type='1']" #已到访
