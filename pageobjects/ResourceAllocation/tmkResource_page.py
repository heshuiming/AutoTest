...
class tmkResourcePage(BasePage):
    # 咨询类别
    ...
    # #来源
    # infomationType_1 = "xpath=>//a[@data-sertype='infomationType'][@data-serval='1']" #H5
    # infomationType_2 = "xpath=>//a[@data-sertype='infomationType'][@data-serval='2']" #公众号
    # infomationType_3 = "xpath=>//a[@data-sertype='infomationType'][@data-serval='3']"#微信小助手
    # infomationType_4 = "xpath=>//a[@data-sertype='infomationType'][@data-serval='4']"#QQ
