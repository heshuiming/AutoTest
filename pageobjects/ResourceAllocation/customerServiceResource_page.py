...
class CustomerServiceResourcePage(BasePage):
    # 咨询类别
    ...
    #来源
    infomationType_1 = "xpath=>//a[@data-sertype='infomationType'][@data-serval='1']" #乐语
    infomationType_2 = "xpath=>//a[@data-sertype='infomationType'][@data-serval='2']" #美洽
    infomationType_3 = "xpath=>//a[@data-sertype='infomationType'][@data-serval='3']" #新媒体微信
    infomationType_4 = "xpath=>//a[@data-sertype='infomationType'][@data-serval='5']" #400电话
    # infomationType_5 = "xpath=>//a[@data-sertype='informationType'][@data-serval='1']" #400直线
    # infomationType_6 = "xpath=>//a[@data-sertype='informationType'][@data-serval='2']" #到访
    # infomationType_7 = "xpath=>//a[@data-sertype='informationType'][@data-serval='4']" #代理报备
    # infomationType_8 = "xpath=>//a[@data-sertype='informationType'][@data-serval='5']" #口碑
    # infomationType_9 = "xpath=>//a[@data-sertype='informationType'][@data-serval='6']" #离线宝
    # infomationType_10 = "xpath=>//a[@data-sertype='informationType'][@data-serval='7']" #其他
    # infomationType_11 = "xpath=>//a[@data-sertype='informationType'][@data-serval='8']" #陌拜
    def Source(self,type):
        if type == 1:
            self.click(self.infomationType_1)
        elif type == 2:
            self.click(self.infomationType_2)
        elif type == 3:
            self.click(self.infomationType_3)
        elif type == 4:
            self.click(self.infomationType_4)
        # elif type == 5:
        #     self.click(self.infomationType_5)
        # elif type == 6:
        #     self.click(self.infomationType_6)
        # elif type == 7:
        #     self.click(self.infomationType_7)
        # elif type == 8:
        #     self.click(self.infomationType_8)
        # elif type == 9:
        #     self.click(self.infomationType_9)
        # elif type == 10:
    ...
    # activityName_input = "xpath=>//input[@name='wechat']"
    ...
    def SearchCondition(self, **info):
        if info['studentName']:
            ...
            self.click(self.search_btn)
        # elif info['wechat']:
        #     self.send_keys(self.activityName_input,info['wechat'])
        #     self.click(self.search_btn)
        else:
            self.click(self.search_btn)

    #客服自主分配
    customer_btn = "xpath=>//input[@id='switch-allocation'][@checked='checked']" #点击打开

    def CustomerServiceAllocation(self):
        pass

    #查看
    check_btn = "xpath=>//td[@datano='0']/button[1]"
    def Check(self):
